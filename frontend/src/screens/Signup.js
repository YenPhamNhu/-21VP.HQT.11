...
function Signup() {
  ...
  const validateForm = () => {
    ...
    if (!values.SDT) {
      ...
      errors.MatKhau = "Số điện thoại không hợp lệ";
    }
              ...
              <MDBCol md='6'>
                ...
                <div className="bg-white p-3 rounded">
                  <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                    <label htmlFor="HoTen"><strong>Họ và tên</strong></label>
                  ...
                  <div className="mb-3">
                    <label htmlFor="DiaChi"><strong>Địa chỉ</strong></label>
                  ...
                  <div className="mb-3">
                    <label htmlFor="NgaySinh"><strong>Ngày sinh</strong></label>
                    <input type="date" placeholder="Ngày sinh" 
                      name='NgaySinh'
                      onChange={handleInput}
                      className="form-control rounded-0"
                    />
                    {errors.NgaySinh && <span className="text-danger">{errors.NgaySinh}</span>}
                  </div>
                  <div className="mb-3">
                    <label htmlFor="GioiTinh"><strong>Giới tính</strong></label>
                    <select className="form-control rounded-0" id="GioiTinh" name="GioiTinh">
                  ...
                  <Link to='/login' className="btn btn-default border w-100 bg-light rounded-0 text-decoration-none">Có tài khoản? Đăng nhập</Link>
                  </form>
                </div>
              </MDBCol>
            </MDBRow>
